...
It is possible to edit this repository and view locally the changes before
pushing by following the steps in `chemiscope documentation <https://chemiscope.org/docs/python/sphinx.html#viewing-a-documentation-locally>`_.
